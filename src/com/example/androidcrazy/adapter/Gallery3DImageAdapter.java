...
public class Gallery3DImageAdapter extends BaseAdapter {
    int mGalleryItemBackground;
    private Context mContext;
    private Integer[] mImageIds;
    private ImageView[] mImages;

    public Gallery3DImageAdapter(Context c, Integer[] ImageIds) {
        mContext = c;
        mImageIds = ImageIds;
    ...
    public boolean createReflectedImages() {
        ...
        for (int imageId : mImageIds) {
            ...
            imageView.setLayoutParams(new FlowGallery.LayoutParams(200, 300));
